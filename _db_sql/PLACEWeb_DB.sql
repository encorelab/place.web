...
CREATE UNIQUE INDEX `name_UNIQUE` ON `placeweb`.`concept` (`name` ASC) ;
...
CREATE UNIQUE INDEX `name_UNIQUE` ON `placeweb`.`activity_type` (`name` ASC) ;
...
CREATE UNIQUE INDEX `table_name_UNIQUE` ON `placeweb`.`votable` (`object` ASC) ;
...
CREATE UNIQUE INDEX `table_name_UNIQUE` ON `placeweb`.`commentable` (`object` ASC) ;
...
CREATE UNIQUE INDEX `table_name_UNIQUE` ON `placeweb`.`assessable` (`object` ASC) ;
...
-- -----------------------------------------------------
-- Table `placeweb`.`assessment_review`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `placeweb`.`assessment_review` ;

CREATE  TABLE IF NOT EXISTS `placeweb`.`assessment_review` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `run_id` INT NOT NULL ,
  `author_id` INT NOT NULL ,
  `date_modified` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP ,
  ...
  `content` TEXT NULL ,
  PRIMARY KEY (`id`) ,
  CONSTRAINT `fk_template_users21`
    FOREIGN KEY (`author_id` )
    REFERENCES `placeweb`.`user` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_template_runs121`
    FOREIGN KEY (`run_id` )
    REFERENCES `placeweb`.`run` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_template_users` ON `placeweb`.`assessment_review` (`author_id` ASC) ;

CREATE INDEX `fk_template_runs` ON `placeweb`.`assessment_review` (`run_id` ASC) ;
...
CREATE  TABLE IF NOT EXISTS `placeweb`.`assessment` (
  ...
  `obj_type` INT NOT NULL ,
  `mark` DOUBLE NULL ,
  `assessment_review_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  ...
  CONSTRAINT `fk_votes_votable100`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_assessments_assessment_reviews1`
    FOREIGN KEY (`assessment_review_id` )
    REFERENCES `placeweb`.`assessment_review` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_assessments_assessment_reviews1` ON `placeweb`.`assessment` (`assessment_review_id` ASC) ;
...
SET AUTOCOMMIT=0;
USE `placeweb`;
INSERT INTO `placeweb`.`run` (`id`, `name`) VALUES ('1', 'first run');
...
SET AUTOCOMMIT=0;
USE `placeweb`;
INSERT INTO `placeweb`.`user` (`id`, `run_id`, `author_id`, `date_modified`, `date_created`, `username`, `password`, `user_type`) VALUES ('1', '1', NULL, NULL, NULL, 'admin', NULL, 'ADMIN');
INSERT INTO `placeweb`.`user` (`id`, `run_id`, `author_id`, `date_modified`, `date_created`, `username`, `password`, `user_type`) VALUES ('2', '1', NULL, NULL, NULL, 'teacher', NULL, 'TEACHER');
INSERT INTO `placeweb`.`user` (`id`, `run_id`, `author_id`, `date_modified`, `date_created`, `username`, `password`, `user_type`) VALUES ('3', '1', NULL, NULL, NULL, 'student1', NULL, 'STUDENT');
INSERT INTO `placeweb`.`user` (`id`, `run_id`, `author_id`, `date_modified`, `date_created`, `username`, `password`, `user_type`) VALUES ('4', '1', NULL, NULL, NULL, 'student2', NULL, 'STUDENT');
