...
Doctrine_Manager::getInstance()->bindComponent('Assessment', 'main');
 ...
 */
abstract class BaseAssessment extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('assessment');
        ...
        $this->hasColumn('mark', 'float', null, array(
             'type' => 'float',
             'fixed' => false,
             'unsigned' => false,
             'primary' => false,
