...
Doctrine_Manager::getInstance()->bindComponent('AssessmentReview', 'main');
 ...
 */
abstract class BaseAssessmentReview extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('assessment_review');
