...
Doctrine_Manager::getInstance()->bindComponent('QuestionConcept', 'main');
 ...
 */
abstract class BaseQuestionConcept extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('question_concept');
