...
/**
		...
		@license http://creativecommons.org/licenses/by-nc/3.0/a
	**/
//	echo getcwd();
	include('configs.php');
...
<?php echo $JAVA_DLG;?>
	...
	<body onLoad="browser.init();">
		<div id="alert" style="display:none;"><p class='error'></p></div>
...
<!--
					<li class="upload_file"><a href="javascript:browser.uploadFile();">
	<?php// echo $DLG['upload_file'];?>
</a></li>
