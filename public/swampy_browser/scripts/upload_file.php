<?php
/** 	ANTO commented all this because it introduces a huge security hole. 
	if you want to use it, be sure you check the extenssions of the 
	files being uploaded. For example, a .php file can be a serious risk 
**/
